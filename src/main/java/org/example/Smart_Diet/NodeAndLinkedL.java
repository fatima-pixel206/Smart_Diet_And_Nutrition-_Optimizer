...
// Niche aik line draw kar dete hain formatting ke liye
    ...
    void suggestCheaper() {
            ...
            // 5 Variables for Top 5
            Node first = null, sec = null, third = null, fourth = null, fifth = null;
            Node temp = head;

            while (temp != null) {
                if (first == null || temp.price < first.price) {
                    fifth = fourth;
                    fourth = third;
                    third = sec;
                    sec = first;
                    first = temp;
                } else if (sec == null || temp.price < sec.price) {
                    fifth = fourth;
                    fourth = third;
                    third = sec;
                    sec = temp;
                } else if (third == null || temp.price < third.price) {
                    fifth = fourth;
                    fourth = third;
                    third = temp;
                } else if (fourth == null || temp.price < fourth.price) {
                    fifth = fourth;
                    fourth = temp;
                } else if (fifth == null || temp.price < fifth.price) {
                    fifth = temp;
                }
                temp = temp.next;
            }
            ...
            // Displaying all 5 if they exist
            if (first != null) printNode(first);
            if (sec != null) printNode(sec);
            if (third != null) printNode(third);
            if (fourth != null) printNode(fourth);
            if (fifth != null) printNode(fifth);
        }


void printNode(Node n) {
    System.out.printf("%-15s %-12s %-8d %-10.1f %-8.1f %-8.1f %-8.1f\n",
            n.foodName, n.category, n.price, n.calories, n.fats, n.crabs, n.proteins);
}
}